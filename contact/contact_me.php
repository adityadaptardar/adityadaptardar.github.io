...
if($_POST)
{
	$to_email   	= "aditya@daptardar.in"; //Recipient email, Replace with own email here
	...
	if(!$send_mail)
	{
		...
		$output = json_encode(array('type'=>'message', 'text' => 'Hi '.$user_name .', I will get back to you shortly.'));
		die($output);
	}
}
?>